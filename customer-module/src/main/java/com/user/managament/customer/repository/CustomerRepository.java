package com.user.managament.customer.repository;

import com.user.managament.customer.dto.CustomersContractStatusDTO;
...
public interface CustomerRepository extends JpaRepository<Customer, UUID>, JpaSpecificationExecutor<Customer> {
    ...
    @Query("SELECT new com.user.managament.customer.dto.CustomersContractStatusDTO(" +
    ...
    @Query("SELECT new com.user.managament.customer.dto.CustomersFrequencyClassDTO(" +
            "c.id, c.name, c.classroomType)" +
            "FROM Customer c " +
            "LEFT JOIN Contract last_contract ON last_contract.customer = c " +
            "AND last_contract.initDate = (SELECT MAX(c_sub.initDate) FROM Contract c_sub WHERE c_sub.customer = c) " +
